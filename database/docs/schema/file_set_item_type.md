...
| sqlite_autoindex_file_set_item_type_1 | PRIMARY KEY | PRIMARY KEY (file_set_id, item_type) |

## Indexes

| Name | Definition |
| ---- | ---------- |
| sqlite_autoindex_file_set_item_type_1 | PRIMARY KEY (file_set_id, item_type) |

## Relations

![er](file_set_item_type.svg)
